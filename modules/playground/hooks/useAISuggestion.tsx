...
interface UseAISuggestionsReturn extends AISuggestionState {
    ...
    rejectSuggestion: (ediotr: any) => void;
    clearSuggestion: (ediotr: any) => void;
}
...
export const useAISuggestions = ():UseAISuggestionsReturn => {
    ...
    const fetchSuggestion = useCallback(async(type: string , editor: any)=>{
        ...
        setState((currentState) => {
            ...
            const cursorPostion = editor.getPosition();

            if(!model || !cursorPostion){
                return currentState;
            }
            ...
            (async()=>{
                try {
                    const payload = {
                        ...
                        cursorLine: cursorPostion.lineNumber - 1,
                        cursorColumn: cursorPostion.column - 1,
                        suggestionType: type
                    }
                    ...
                    if(data.suggestion) {
                        ...
                        console.error("No suggestion received from API");
