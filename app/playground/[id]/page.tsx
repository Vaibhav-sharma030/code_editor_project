...
const MainPlaygroundPage = () => {
    ...
    const handleSave = useCallback(async (fileId?: string) => {
      ...
      try {
        ...
        if(!filePath) {
          toast.error(`Could not find path for the file: ${fileToSave.filename}.${fileToSave.fileExtension}`);
          return ;
        }
  ...
  return (
    <TooltipProvider>
        ...
        />
        <SidebarInset>
          <header className='flex h-15 shrink-0 items-center gsp-2 px-4 border-b'>
